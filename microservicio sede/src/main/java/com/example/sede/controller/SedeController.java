...
public class SedeController {
    ...
    @Operation(
        ...
        description = "Obtiene todas las sedes que se encuentran activas en el sistema"
        )
            @ApiResponses(value = {
    ...
    @Operation(
        ...
        description = "Obtiene la información de una sede específica mediante su identificador"
        )
        @ApiResponses(value = {
    ...
    @Operation(
        ...
        description = "Permite modificar los datos de una sede existente"
        )
        @ApiResponses(value = {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SedeResponseDTO> actualizar(@PathVariable Long id,
    ...
    @Operation(
        ...
        description = "Desactiva una sede para que deje de estar disponible en el sistema"
        )
        @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Sede desactivada correctamente"),
        @ApiResponse(responseCode = "400", description = "La sede ya estaba desactivada"),
        @ApiResponse(responseCode = "404", description = "Sede no encontrada"),
        @ApiResponse(responseCode = "500", description = "Error interno del servidor")
        })
